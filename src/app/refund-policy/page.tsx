        ...
        <div className="container" style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ lineHeight: '1.9', fontSize: '15px', color: '#374151' }}>
            <ul style={{ listStyleType: 'disc', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <li>
                100% fee to be paid in advance to start the training with M-Tech Computers.
              </li>
              <li>
              ...
              <li>
                Any promotion code/Gift use to purchased M-Tech Computers course shall not in the entitlement of Refund and adjustment.
              </li>
              <li>
