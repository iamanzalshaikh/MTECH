            ...
            {branches.map((branch) => (
              ...
              >
                <h3
                  ...
                  style={{ fontSize: '20px', color: 'var(--clr-primary)', marginBottom: '16px', fontWeight: '700' }}
                >
                  {branch.name}
                </h3>
                ...
                <a
                  ...
                  id={`live-location-${branch.badge.toLowerCase().replace(/\s+/g, '-')}`}
                  style={{
                    marginTop: '22px',
                    width: '100%',
                    display: 'inline-flex',
                ...
                >
                  📍 Live Location — Open on Google Maps
                </a>
              </div>
            ))}
          </div>
